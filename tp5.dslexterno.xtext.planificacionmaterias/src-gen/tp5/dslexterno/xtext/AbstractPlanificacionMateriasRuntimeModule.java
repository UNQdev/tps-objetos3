...
/**
 * Manual modifications go to {tp5.dslexterno.xtext.PlanificacionMateriasRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractPlanificacionMateriasRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "tp5/dslexterno/xtext/PlanificacionMaterias.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("tp5.dslexterno.xtext.PlanificacionMaterias");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return tp5.dslexterno.xtext.services.PlanificacionMateriasGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return tp5.dslexterno.xtext.serializer.PlanificacionMateriasSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return tp5.dslexterno.xtext.serializer.PlanificacionMateriasSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return tp5.dslexterno.xtext.parser.antlr.PlanificacionMateriasParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return tp5.dslexterno.xtext.parser.antlr.PlanificacionMateriasAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return tp5.dslexterno.xtext.parser.antlr.internal.InternalPlanificacionMateriasLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<tp5.dslexterno.xtext.parser.antlr.internal.InternalPlanificacionMateriasLexer> provideInternalPlanificacionMateriasLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(tp5.dslexterno.xtext.parser.antlr.internal.InternalPlanificacionMateriasLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(tp5.dslexterno.xtext.parser.antlr.internal.InternalPlanificacionMateriasLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends tp5.dslexterno.xtext.validation.PlanificacionMateriasValidator> bindPlanificacionMateriasValidator() {
		return tp5.dslexterno.xtext.validation.PlanificacionMateriasValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return tp5.dslexterno.xtext.formatting.PlanificacionMateriasFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return tp5.dslexterno.xtext.jvmmodel.PlanificacionMateriasJvmModelInferrer.class;
	}
