...
public interface Planificacion extends EObject
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Asignacion De Materias</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Asignacion De Materias</em>' containment reference list.
   * @see tp5.dslexterno.xtext.planificacionMaterias.PlanificacionMateriasPackage#getPlanificacion_AsignacionDeMaterias()
   * @model containment="true"
   * @generated
   */
  EList<Asignacion_Materia> getAsignacionDeMaterias();
