...
* generated by Xtext
*/
package tp5.dslexterno.xtext.ui.contentassist.antlr;
...
public class PlanificacionMateriasParser extends AbstractContentAssistParser {
	...
	@Override
	protected tp5.dslexterno.xtext.ui.contentassist.antlr.internal.InternalPlanificacionMateriasParser createParser() {
		tp5.dslexterno.xtext.ui.contentassist.antlr.internal.InternalPlanificacionMateriasParser result = new tp5.dslexterno.xtext.ui.contentassist.antlr.internal.InternalPlanificacionMateriasParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getEstructuras_PlanificacionAccess().getAlternatives(), "rule__Estructuras_Planificacion__Alternatives");
					put(grammarAccess.getDisponibilidadAccess().getAlternatives(), "rule__Disponibilidad__Alternatives");
					...
					put(grammarAccess.getMaterias_AbiertasAccess().getGroup(), "rule__Materias_Abiertas__Group__0");
					put(grammarAccess.getAulas_DisponiblesAccess().getGroup(), "rule__Aulas_Disponibles__Group__0");
					put(grammarAccess.getNomina_ProfesoresAccess().getGroup(), "rule__Nomina_Profesores__Group__0");
					put(grammarAccess.getAsignacion_MateriaAccess().getGroup(), "rule__Asignacion_Materia__Group__0");
					...
					put(grammarAccess.getDisponibilidadAccess().getGroup_2(), "rule__Disponibilidad__Group_2__0");
					put(grammarAccess.getDisponibilidadAccess().getGroup_3(), "rule__Disponibilidad__Group_3__0");
					...
					put(grammarAccess.getRango_HorarioAccess().getGroup(), "rule__Rango_Horario__Group__0");
					...
					put(grammarAccess.getModelAccess().getElementosPlanificacionAssignment_0(), "rule__Model__ElementosPlanificacionAssignment_0");
					put(grammarAccess.getModelAccess().getPlanificacionAssignment_1(), "rule__Model__PlanificacionAssignment_1");
					put(grammarAccess.getMaterias_AbiertasAccess().getMateriasAbiertasAssignment_3(), "rule__Materias_Abiertas__MateriasAbiertasAssignment_3");
					put(grammarAccess.getAulas_DisponiblesAccess().getAulasDisponiblesAssignment_3(), "rule__Aulas_Disponibles__AulasDisponiblesAssignment_3");
					put(grammarAccess.getNomina_ProfesoresAccess().getProfesoresLibresAssignment_3(), "rule__Nomina_Profesores__ProfesoresLibresAssignment_3");
					put(grammarAccess.getAsignacion_MateriaAccess().getDiaAssignment_0(), "rule__Asignacion_Materia__DiaAssignment_0");
					put(grammarAccess.getAsignacion_MateriaAccess().getRangoHorarioAssignment_1(), "rule__Asignacion_Materia__RangoHorarioAssignment_1");
					put(grammarAccess.getAsignacion_MateriaAccess().getMateriaAssignment_3(), "rule__Asignacion_Materia__MateriaAssignment_3");
					...
					put(grammarAccess.getMateriaAccess().getAulaAssignment_8(), "rule__Materia__AulaAssignment_8");
					...
					put(grammarAccess.getProfesorAccess().getDisponibilidadAssignment_5(), "rule__Profesor__DisponibilidadAssignment_5");
					...
					put(grammarAccess.getDisponibilidadAccess().getRangoHorarioAssignment_1_2(), "rule__Disponibilidad__RangoHorarioAssignment_1_2");
					put(grammarAccess.getDisponibilidadAccess().getDiaAssignment_2_1(), "rule__Disponibilidad__DiaAssignment_2_1");
					put(grammarAccess.getDisponibilidadAccess().getDiaAssignment_3_1(), "rule__Disponibilidad__DiaAssignment_3_1");
					put(grammarAccess.getDisponibilidadAccess().getRangoHorarioAssignment_3_2(), "rule__Disponibilidad__RangoHorarioAssignment_3_2");
					...
					put(grammarAccess.getAulaAccess().getRecusosAssignment_7(), "rule__Aula__RecusosAssignment_7");
					put(grammarAccess.getRecursoAccess().getNameAssignment(), "rule__Recurso__NameAssignment");
					put(grammarAccess.getHorarioAccess().getHoraAssignment_0(), "rule__Horario__HoraAssignment_0");
					put(grammarAccess.getHorarioAccess().getMinutosAssignment_2(), "rule__Horario__MinutosAssignment_2");
					put(grammarAccess.getRango_HorarioAccess().getHoraInicioAssignment_1(), "rule__Rango_Horario__HoraInicioAssignment_1");
					put(grammarAccess.getRango_HorarioAccess().getHoraFinalAssignment_3(), "rule__Rango_Horario__HoraFinalAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			tp5.dslexterno.xtext.ui.contentassist.antlr.internal.InternalPlanificacionMateriasParser typedParser = (tp5.dslexterno.xtext.ui.contentassist.antlr.internal.InternalPlanificacionMateriasParser) parser;
