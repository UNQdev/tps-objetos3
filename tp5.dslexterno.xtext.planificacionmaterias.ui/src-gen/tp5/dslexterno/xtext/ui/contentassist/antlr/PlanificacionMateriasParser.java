	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getElementosAccess().getAlternatives(), "rule__Elementos__Alternatives");
					...
					put(grammarAccess.getModelAccess().getElementosAssignment_0(), "rule__Model__ElementosAssignment_0");
					put(grammarAccess.getModelAccess().getPlanificacionAssignment_1(), "rule__Model__PlanificacionAssignment_1");
					put(grammarAccess.getNomina_ProfesoresAccess().getProfesorsLibresAssignment_3(), "rule__Nomina_Profesores__ProfesorsLibresAssignment_3");
					put(grammarAccess.getAulas_DisponiblesAccess().getAulasAssignment_3(), "rule__Aulas_Disponibles__AulasAssignment_3");
					put(grammarAccess.getMaterias_AbiertasAccess().getMateriasADictarAssignment_3(), "rule__Materias_Abiertas__MateriasADictarAssignment_3");
					...
					put(grammarAccess.getAsignacion_MateriaAccess().getHoraInicioAssignment_2(), "rule__Asignacion_Materia__HoraInicioAssignment_2");
					put(grammarAccess.getAsignacion_MateriaAccess().getHoraFinalAssignment_4(), "rule__Asignacion_Materia__HoraFinalAssignment_4");
					put(grammarAccess.getAsignacion_MateriaAccess().getMateriaAssignment_6(), "rule__Asignacion_Materia__MateriaAssignment_6");
					...
					put(grammarAccess.getAulaAccess().getNumeroAssignment_1(), "rule__Aula__NumeroAssignment_1");
					put(grammarAccess.getAulaAccess().getRecusosAssignment_4(), "rule__Aula__RecusosAssignment_4");
					put(grammarAccess.getRecursoAccess().getNombreAssignment(), "rule__Recurso__NombreAssignment");
