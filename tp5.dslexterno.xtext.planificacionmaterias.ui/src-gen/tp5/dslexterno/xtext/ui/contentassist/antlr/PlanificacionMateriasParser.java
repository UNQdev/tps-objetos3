		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAsignacion_DiariaAccess().getGroup(), "rule__Asignacion_Diaria__Group__0");
					put(grammarAccess.getMateriaAccess().getGroup(), "rule__Materia__Group__0");
					put(grammarAccess.getMateriaAccess().getGroup_7(), "rule__Materia__Group_7__0");
					...
					put(grammarAccess.getAulaAccess().getGroup_6(), "rule__Aula__Group_6__0");
					put(grammarAccess.getHorarioAccess().getGroup(), "rule__Horario__Group__0");
					put(grammarAccess.getHorarioAccess().getGroup_1(), "rule__Horario__Group_1__0");
					...
					put(grammarAccess.getModelAccess().getProfesoresLibresAssignment_2(), "rule__Model__ProfesoresLibresAssignment_2");
					put(grammarAccess.getModelAccess().getAulasDisponiblesAssignment_6(), "rule__Model__AulasDisponiblesAssignment_6");
					put(grammarAccess.getModelAccess().getMateriasAbiertasAssignment_10(), "rule__Model__MateriasAbiertasAssignment_10");
					put(grammarAccess.getModelAccess().getPlanificacionAssignment_12(), "rule__Model__PlanificacionAssignment_12");
					...
					put(grammarAccess.getPlanificacionAccess().getAsignacionesDeMateriasAssignment_7(), "rule__Planificacion__AsignacionesDeMateriasAssignment_7");
					put(grammarAccess.getAsignacion_MateriaAccess().getMateriaAssignment_0(), "rule__Asignacion_Materia__MateriaAssignment_0");
					put(grammarAccess.getAsignacion_MateriaAccess().getProfesorAssignment_3(), "rule__Asignacion_Materia__ProfesorAssignment_3");
					put(grammarAccess.getAsignacion_MateriaAccess().getAulaAssignment_5(), "rule__Asignacion_Materia__AulaAssignment_5");
					put(grammarAccess.getAsignacion_MateriaAccess().getAlumnosInscriptosAssignment_7(), "rule__Asignacion_Materia__AlumnosInscriptosAssignment_7");
					put(grammarAccess.getAsignacion_MateriaAccess().getAsignacionesDiariasAssignment_10(), "rule__Asignacion_Materia__AsignacionesDiariasAssignment_10");
					put(grammarAccess.getAsignacion_DiariaAccess().getDiaAssignment_0(), "rule__Asignacion_Diaria__DiaAssignment_0");
					put(grammarAccess.getAsignacion_DiariaAccess().getRangoHorarioAssignment_1(), "rule__Asignacion_Diaria__RangoHorarioAssignment_1");
					put(grammarAccess.getMateriaAccess().getNameAssignment_1(), "rule__Materia__NameAssignment_1");
					put(grammarAccess.getMateriaAccess().getCantidadHorasSemanalesAssignment_4(), "rule__Materia__CantidadHorasSemanalesAssignment_4");
					put(grammarAccess.getMateriaAccess().getDiasSemanalesAssignment_6(), "rule__Materia__DiasSemanalesAssignment_6");
					put(grammarAccess.getMateriaAccess().getRequerimientosAssignment_7_1(), "rule__Materia__RequerimientosAssignment_7_1");
					...
					put(grammarAccess.getHorarioAccess().getMinutosAssignment_1_1(), "rule__Horario__MinutosAssignment_1_1");
